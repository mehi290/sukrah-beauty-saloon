...
const testimonials = [
  {
    ...
    rating: 5,
    text: "Sehrish Beauty Saloon has completely transformed my hair care routine. The attention to detail and personalized service is unmatched in Dubai. My balayage has never looked better!",
  },
  {
    id: 2,
    name: "Elena Petrova",
    ...
    rating: 5,
    text: "As someone who has tried many salons in Dubai Marina, I can confidently say Sehrish Beauty Saloon is in a league of its own. The keratin treatment lasted months longer than anywhere else.",
  },
  {
    id: 3,
    name: "Priya Sharma",
